...
namespace CSharpServer
{
    ...
    public class Api_HIK
    {
        ...
        public void RealDataCallBack(Int32 lRealHandle, UInt32 dwDataType, IntPtr pBuffer, UInt32 dwBufSize, IntPtr pUser)
        {
            ...
            {
                byte[] psData = new byte[dwBufSize];
                Marshal.Copy(pBuffer, psData, 0, (Int32)dwBufSize);
                ...
                //if (dic_cache.ContainsKey())
                //{

                //}
                if (psData[0] == 0 && psData[1] == 0 && psData[2] == 1 && psData[3] == 186)//00 00 01 ba,ps流起始
                {
                ...
                else if (psData[0] == 0 && psData[1] == 0 && psData[2] == 1 && psData[3] == 223)//000001DF,pes分组头部，DF:音频
                {
                    if (dic_cache[key].Count != 0)
                        dic_cache[key].AddRange(psData);
                }
                else if (psData[0] == 0 && psData[1] == 0 && psData[2] == 1 && psData[3] == 224)////000001E0,pes分组头部，E0:视频
                {
                    if (dic_cache[key].Count != 0)
                        dic_cache[key].AddRange(psData);
                }
        ...
        static Dictionary<string, List<byte>> dic_cache = new Dictionary<string, List<byte>>();
        //static int num = 0;
        //void HIKDataInput()
        //{
        //    num++;
