...
namespace CSharpServer
{
   ...
   //     }
        ...
        **********************************************************/
        ...
        [DllImport(@"HIKdll\HCNetSDK.dll")]
        public static extern bool NET_DVR_SetESRealPlayCallBack(int lRealHandle, PlayESCallBack playESCallBack, IntPtr pUser);
        public delegate void PlayESCallBack(int lPreviewHandle, NET_DVR_PACKET_INFO_EX pstruPackInfo, IntPtr pUser);
        ...
        **********************************************************/
        ...
        [DllImportAttribute(@"HIKdll\HCNetSDK.dll")]
